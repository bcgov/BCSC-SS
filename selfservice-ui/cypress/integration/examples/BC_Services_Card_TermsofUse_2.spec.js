...
{   
    ...
    it('Visit the BC Dev Page and Login', function(){
        ...
        cy.wait(time_ms)
        cy.get('input[data-test-id="input-profile-phone"]').type('<PhoneNumber>').should('have.value', '<PhoneNumber>')
        cy.wait(time_ms)
        ...
        cy.url().should('eq','https://selfservice-dev.pathfinder.gov.bc.ca/profile/complete')
        ...
        cy.visit('https://selfservice-dev.pathfinder.gov.bc.ca/profile/complete')
