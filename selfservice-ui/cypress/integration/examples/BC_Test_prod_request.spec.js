...
        cy.get('#tile_btn_virtual_device_div_id').click()
        cy.wait(time_ms)
        cy.log("Opens up the page with BC Services Card Login details")
        cy.wait(time_ms)
        //Type the Card serial number and passcode - Use Card serial Number that has atleast one project in Development phase
