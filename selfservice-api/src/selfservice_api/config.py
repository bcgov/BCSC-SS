...
CONFIGURATION = {
    'development': 'selfservice_api.config.DevConfig',
    'testing': 'selfservice_api.config.TestConfig',
    'production': 'selfservice_api.config.ProdConfig',
    'default': 'selfservice_api.config.ProdConfig'
}
        ...
        'keys': [
            {
                ...
                'n': 'AN-fWcpCyE5KPzHDjigLaSUVZI0uYrcGcc40InVtl-rQRDmAh-C2W8H4_Hxhr5VLc6crsJ2LiJTV_E72S03pzpOOaaYV6-TzAjCou2GYJIXev7f6Hh512PuG5wyxda_TlBSsI-gvphRTPsKCnPutrbiukCYrnPuWxX5_cES9eStR',  # noqa: E501  # pylint: disable=line-too-long
                'e': 'AQAB',
                'd': 'C0G3QGI6OQ6tvbCNYGCqq043YI_8MiBl7C5dqbGZmx1ewdJBhMNJPStuckhskURaDwk4-8VBW9SlvcfSJJrnZhgFMjOYSSsBtPGBIMIdM5eSKbenCCjO8Tg0BUh_xa3CHST1W4RQ5rFXadZ9AeNtaGcWj2acmXNO3DVETXAX3x0',  # noqa: E501  # pylint: disable=line-too-long
                'p': 'APXcusFMQNHjh6KVD_hOUIw87lvK13WkDEeeuqAydai9Ig9JKEAAfV94W6Aftka7tGgE7ulg1vo3eJoLWJ1zvKM',  # noqa: E501  # pylint: disable=line-too-long
                'q': 'AOjX3OnPJnk0ZFUQBwhduCweRi37I6DAdLTnhDvcPTrrNWuKPg9uGwHjzFCJgKd8KBaDQ0X1rZTZLTqi3peT43s',  # noqa: E501  # pylint: disable=line-too-long
                'dp': 'AN9kBoA5o6_Rl9zeqdsIdWFmv4DB5lEqlEnC7HlAP-3oo3jWFO9KQqArQL1V8w2D4aCd0uJULiC9pCP7aTHvBhc',  # noqa: E501  # pylint: disable=line-too-long
                'dq': 'ANtbSY6njfpPploQsF9sU26U0s7MsuLljM1E8uml8bVJE1mNsiu9MgpUvg39jEu9BtM2tDD7Y51AAIEmIQex1nM',  # noqa: E501  # pylint: disable=line-too-long
                'qi': 'XLE5O360x - MhsdFXx8Vwz4304 - MJg - oGSJXCK_ZWYOB_FGXFRTfebxCsSYi0YwJo - oNu96bvZCuMplzRI1liZw'  # noqa: E501  # pylint: disable=line-too-long
            }
        ]
    }
